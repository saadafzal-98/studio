    ...
    <div className="bg-[#333] min-h-screen">
       <header className="text-white py-2">
        <div className="container mx-auto max-w-sm px-4">
            <h2 className="font-semibold text-sm text-center mb-2">Poultry Receipt Generator</h2>
            <div className="flex justify-between items-center">
                <Button className="bg-[#25D366] hover:bg-[#128C7E] text-white rounded-md px-3 text-xs h-8">
                ...
                <Button variant="outline" className="border-gray-600 text-gray-300 rounded-md px-3 text-xs h-8 hover:bg-gray-700 hover:text-white">
                    <span>ترمیم</span>
                    <ChevronLeft />
                </Button>
            </div>
